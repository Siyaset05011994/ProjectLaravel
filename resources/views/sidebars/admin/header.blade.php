                    ...
                    <div class="dropdown-tasks dropdown-menu dropdown-menu-right animated fadeInUp">
                        <div class="t-item">
                            ...
                            <span class="avatar box-32">
											<img src="{{asset('admin/img/avatars/2.jpg')}}" alt="">
										</span>
                        ...
                        <div class="t-item">
                            ...
                            <span class="avatar box-32">
											<img src="{{asset('admin/img/avatars/3.jpg')}}" alt="">
										</span>
                        ...
                        <div class="t-item">
                            ...
                            <span class="avatar box-32">
											<img src="{{asset('admin/img/avatars/4.jpg')}}" alt="">
										</span>
                        ...
                        <div class="t-item">
                            ...
                            <span class="avatar box-32">
											<img src="{{asset('admin/img/avatars/5.jpg')}}" alt="">
										</span>
                        ...
                        <div class="a-grid">
                            <div class="row row-sm">
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="{{asset('admin/img/brands/dropbox.png')}}" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="{{asset('admin/img/brands/github.png')}}" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="{{asset('admin/img/brands/wordpress.png')}}" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="{{asset('admin/img/brands/gmail.png')}}" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="{{asset('admin/img/brands/drive.png')}}" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="{{asset('admin/img/brands/dribbble.png')}}" alt=""></div>
