        ...
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <div class="overflow-x-auto">
                        ...
                        @foreach($users as $user)
                                <tr>
                                    ...
                                    @if($current_user_creator==0)
                                        @if($user->creator!=0)
                                            <td>
                                                <a href="{{route('self_users',$user->creator)}}">{{\App\Models\User::where('id',$user->creator)->first()->name}} </a>
                                            </td>
                                        @else
                                            <td>-</td>
                                        @endif
                    ...
                    @else
                        <div>
                            <span>{{$users->total()}} məlumatdan {{$users->firstItem()}} - {{$users->lastItem()}} aralığı .</span>
                        </div>
